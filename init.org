...
** Time sensitive
*** System
[[https://www.reddit.com/r/emacs/comments/3kqt6e/2_easy_little_known_steps_to_speed_up_emacs_start/][Jank]]
#+BEGIN_SRC emacs-lisp
  (setq gc-cons-threshold 100000000)
#+END_SRC
*** UI
Now that the legal stuff is out of the way, let's get out the rat
poison.  This code is important to run as early as possible, to avoid
