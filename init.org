...
(use-package evil-leader :ensure t
  ...
  (setq evil-leader/no-prefix-mode-rx '("dired-mode"
                                        "magit-.*-mode"))
  (evil-leader/set-key "y" 'execute-extended-command)
  (evil-leader-mode 1))
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (evil-surround evil-escape which-key use-package ivy evil-leader avy))))
(custom-set-faces
