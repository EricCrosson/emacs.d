...
#+BEGIN_SRC emacs-lisp
  (use-package typescript-mode
    ...
    (defun esc-config-typescript-mode ()
      (define-key typescript-mode-map (vector 'remap 'fill-paragraph) 'js-fill-paragraph))
...
#+BEGIN_SRC emacs-lisp
  (use-package tide
    ...
    (add-hook 'typescript-mode-hook 'tide/configure-tide))
#+END_SRC

***** web-mode config
#+BEGIN_SRC emacs-lisp
...
#  LocalWords:  gtd Tronesque darkokai
