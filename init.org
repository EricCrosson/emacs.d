...
** FIC-mode config
   #+BEGIN_SRC emacs-lisp :comments link :tangle yes
     (use-package fic-mode
       ...
       :defer t
       :config
       ;; strange happenstance here. This function is defined in some
       ;; versions of this package, but not in the elpa version.
       ;;
       ;; perhaps include a wrapper, only defining if not already a defun
